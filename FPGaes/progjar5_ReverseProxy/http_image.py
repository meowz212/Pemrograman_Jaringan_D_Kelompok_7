...
class HttpServer:
	...
	def http_get(self,object_address,headers):
		...
		# print(files)
		thedir='./'
		if (object_address == '/images/'):
			return self.response(200,'OK','Ini Adalah web Server percobaan untuk images',dict())

		object_address=object_address[1:]
		# print("asiyappp")
		finpath = thedir + object_address
		finpath = finpath.replace(r'/', '\\')
		# print(finpath)
		if finpath not in files:
			return self.response(404, 'Not Found', '', {})
		# rb => artinya adalah read dalam bentuk binary
		fp = open(thedir + object_address, 'rb')
		# if (open(thedir + object_address, 'rb')):
		# 	return self.response(404, 'Not Found', '', {})
